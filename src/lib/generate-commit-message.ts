...
export async function generateCommitMessage({
  ...
  Your task is to generate a single, well-structured Conventional Commit message based on the pull request details below. Prioritize user comments first, then the pull request title, and finally the description.
